...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=RoboMMEDataConfig(
            repo_id="robomme",
            # LoRA changes the parameterization, not the robot/action
            # normalization, so reuse the MME-VLA normalization assets.
        ...
        keep_period=10_000,
        num_workers=4,
        # Match the full-parameter baseline for a controlled comparison.
        ema_decay=0.999,
        fsdp_devices=4,
    ),
]
